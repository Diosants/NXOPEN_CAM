...
public class M18
{
    public static void Run(string[] args)
    {
        ...
        operation1 = workPart.CAMSetup.CAMOperationCollection.CreateWithUserName(nCGroup1, method1, nCGroup2, featureGeometry1, "hole_making", "SPOT_DRILLING", NXOpen.CAM.OperationCollection.UseDefaultName.False, "CENTER-DRILL-M18", "Spot Drilling");
        ...
        nCGroup4 = workPart.CAMSetup.CAMGroupCollection.CreateToolWithUserName(nCGroup3, "hole_making", "CENTERDRILL", NXOpen.CAM.NCGroupCollection.UseDefaultName.False, "CENTER-TAP-M16", "CENTER-TAP-M18");
        ...
        NXOpen.CAM.FeatureGeometry featureGeometry2 = ((NXOpen.CAM.FeatureGeometry)workPart.CAMSetup.CAMGroupCollection.FindObject("M18"));
        if (workPart.CAMSetup.CAMGroupCollection.FindObject("M18") == null)
        {

            theUI.NXMessageBox.Show("Error", NXOpen.NXMessageBox.DialogType.Error, "Feature Geometry M18 not found.");
            return;
        }
        ...
        operation2 = workPart.CAMSetup.CAMOperationCollection.CreateWithUserName(nCGroup1, method1, nCGroup2, featureGeometry1, "hole_making", "DRILLING", NXOpen.CAM.OperationCollection.UseDefaultName.False, "DRILL-D16", "Drilling");
        ...
        nCGroup5 = workPart.CAMSetup.CAMGroupCollection.CreateToolWithUserName(nCGroup3, "hole_making", "STD_DRILL", NXOpen.CAM.NCGroupCollection.UseDefaultName.False, "HSS-D16", "Std Drill");
        ...
        drillStdToolBuilder1.TlDiameterBuilder.Value = 16;
        ...
        operation3 = workPart.CAMSetup.CAMOperationCollection.CreateWithUserName(nCGroup1, method1, nCGroup2, featureGeometry1, "hole_making", "COUNTERSINKING", NXOpen.CAM.OperationCollection.UseDefaultName.False, "DEBUR-M18", "Countersinking");
        ...
        nCGroup6 = workPart.CAMSetup.CAMGroupCollection.CreateToolWithUserName(nCGroup3, "hole_making", "COUNTER_SINK", NXOpen.CAM.NCGroupCollection.UseDefaultName.True, "CHAMFERER-D18", "Counter Sink");
        ...
        drillCtskToolBuilder1.TlDiameterBuilder.Value = 20;
        ...
        operation4 = workPart.CAMSetup.CAMOperationCollection.CreateWithUserName(nCGroup1, method1, nCGroup2, featureGeometry2, "hole_making", "TAPPING", NXOpen.CAM.OperationCollection.UseDefaultName.False, "TAP-M18", "TAP-M18");
        ...
        nCGroup7 = workPart.CAMSetup.CAMGroupCollection.CreateToolWithUserName(nCGroup3, "hole_making", "TAP", NXOpen.CAM.NCGroupCollection.UseDefaultName.False, "TAPPER-M18", "Tap");
        ...
        drillTapToolBuilder1.TlDiameterBuilder.Value = 18;
