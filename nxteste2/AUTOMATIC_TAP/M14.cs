...
public class M14
{
    public static void Run(string[] args)
    {
        ...
        operation1 = workPart.CAMSetup.CAMOperationCollection.CreateWithUserName(nCGroup1, method1, nCGroup2, featureGeometry1, "hole_making", "SPOT_DRILLING", NXOpen.CAM.OperationCollection.UseDefaultName.False, "CENTER-DRILL-M14", "Spot Drilling");
        ...
        nCGroup4 = workPart.CAMSetup.CAMGroupCollection.CreateToolWithUserName(nCGroup3, "hole_making", "CENTERDRILL", NXOpen.CAM.NCGroupCollection.UseDefaultName.False, "CENTER-TAP-M14", "CENTER-TAP-M14");
        ...
        NXOpen.CAM.FeatureGeometry featureGeometry2 = ((NXOpen.CAM.FeatureGeometry)workPart.CAMSetup.CAMGroupCollection.FindObject("M14"));
        if (workPart.CAMSetup.CAMGroupCollection.FindObject("M14") == null)
        {

            theUI.NXMessageBox.Show("Error", NXOpen.NXMessageBox.DialogType.Error, "Feature Geometry M14 not found.");
            return;
        }
        ...
        operation2 = workPart.CAMSetup.CAMOperationCollection.CreateWithUserName(nCGroup1, method1, nCGroup2, featureGeometry1, "hole_making", "DRILLING", NXOpen.CAM.OperationCollection.UseDefaultName.False, "DRILL-D12", "Drilling");
        ...
        // GETTING TOOL DIAM 12
        NXOpen.CAM.NCGroup nCGroup5;
        nCGroup5 = workPart.CAMSetup.CAMGroupCollection.CreateToolWithUserName(nCGroup3, "hole_making", "STD_DRILL", NXOpen.CAM.NCGroupCollection.UseDefaultName.False, "HSS-D12", "Std Drill");
        ...
        drillStdToolBuilder1.TlDiameterBuilder.Value = 12;
        ...
        operation3 = workPart.CAMSetup.CAMOperationCollection.CreateWithUserName(nCGroup1, method1, nCGroup2, featureGeometry1, "hole_making", "COUNTERSINKING", NXOpen.CAM.OperationCollection.UseDefaultName.False, "DEBUR-M14", "Countersinking");
        ...
        nCGroup6 = workPart.CAMSetup.CAMGroupCollection.CreateToolWithUserName(nCGroup3, "hole_making", "COUNTER_SINK", NXOpen.CAM.NCGroupCollection.UseDefaultName.True, "CHAMFERER-D14", "Counter Sink");
        ...
        operation4 = workPart.CAMSetup.CAMOperationCollection.CreateWithUserName(nCGroup1, method1, nCGroup2, featureGeometry2, "hole_making", "TAPPING", NXOpen.CAM.OperationCollection.UseDefaultName.False, "TAP-M14", "TAP-M14");
        ...
        nCGroup7 = workPart.CAMSetup.CAMGroupCollection.CreateToolWithUserName(nCGroup3, "hole_making", "TAP", NXOpen.CAM.NCGroupCollection.UseDefaultName.False, "TAPPER-M14", "Tap");
        ...
        drillTapToolBuilder1.TlDiameterBuilder.Value = 14;
