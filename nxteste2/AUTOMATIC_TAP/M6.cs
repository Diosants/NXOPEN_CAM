...
public class M6
{
    public static void Run(string[] args)
    {
        ...
        NXOpen.CAM.FeatureGeometry featureGeometry2 = ((NXOpen.CAM.FeatureGeometry)workPart.CAMSetup.CAMGroupCollection.FindObject("M6"));
        if (workPart.CAMSetup.CAMGroupCollection.FindObject("M8") == null)
        {

            theUI.NXMessageBox.Show("Error", NXOpen.NXMessageBox.DialogType.Error, "Feature Geometry M6 not found.");
            return;
        }
        ...
        operation2 = workPart.CAMSetup.CAMOperationCollection.CreateWithUserName(nCGroup1, method1, nCGroup2, featureGeometry1, "hole_making", "DRILLING", NXOpen.CAM.OperationCollection.UseDefaultName.False, "DRILL-D5", "Drilling");
        ...
        drillTapToolBuilder1.TlDiameterBuilder.Value = 5;
