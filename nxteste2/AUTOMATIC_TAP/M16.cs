...
public class M16
{
    public static void Run(string[] args)
    {
        ...
        operation1 = workPart.CAMSetup.CAMOperationCollection.CreateWithUserName(nCGroup1, method1, nCGroup2, featureGeometry1, "hole_making", "SPOT_DRILLING", NXOpen.CAM.OperationCollection.UseDefaultName.False, "CENTER-DRILL-M16", "Spot Drilling");
        ...
        nCGroup4 = workPart.CAMSetup.CAMGroupCollection.CreateToolWithUserName(nCGroup3, "hole_making", "CENTERDRILL", NXOpen.CAM.NCGroupCollection.UseDefaultName.False, "CENTER-TAP-M16", "CENTER-TAP-M16");
        ...
        NXOpen.CAM.FeatureGeometry featureGeometry2 = ((NXOpen.CAM.FeatureGeometry)workPart.CAMSetup.CAMGroupCollection.FindObject("M16"));
        if (workPart.CAMSetup.CAMGroupCollection.FindObject("M16") == null)
        {

            theUI.NXMessageBox.Show("Error", NXOpen.NXMessageBox.DialogType.Error, "Feature Geometry M16 not found.");
            return;
        }
        ...
        operation2 = workPart.CAMSetup.CAMOperationCollection.CreateWithUserName(nCGroup1, method1, nCGroup2, featureGeometry1, "hole_making", "DRILLING", NXOpen.CAM.OperationCollection.UseDefaultName.False, "DRILL-D14.5", "Drilling");
        ...
        // GETTING TOOL DIAM 14.5
        NXOpen.CAM.NCGroup nCGroup5;
        nCGroup5 = workPart.CAMSetup.CAMGroupCollection.CreateToolWithUserName(nCGroup3, "hole_making", "STD_DRILL", NXOpen.CAM.NCGroupCollection.UseDefaultName.False, "HSS-D14.5", "Std Drill");
        ...
        drillStdToolBuilder1.TlDiameterBuilder.Value = 14.5;
        ...
        operation3 = workPart.CAMSetup.CAMOperationCollection.CreateWithUserName(nCGroup1, method1, nCGroup2, featureGeometry1, "hole_making", "COUNTERSINKING", NXOpen.CAM.OperationCollection.UseDefaultName.False, "DEBUR-M16", "Countersinking");
        ...
        drillCtskToolBuilder1.TlDiameterBuilder.Value = 18;
        ...
        operation4 = workPart.CAMSetup.CAMOperationCollection.CreateWithUserName(nCGroup1, method1, nCGroup2, featureGeometry2, "hole_making", "TAPPING", NXOpen.CAM.OperationCollection.UseDefaultName.False, "TAP-M16", "TAP-M16");
        ...
        nCGroup7 = workPart.CAMSetup.CAMGroupCollection.CreateToolWithUserName(nCGroup3, "hole_making", "TAP", NXOpen.CAM.NCGroupCollection.UseDefaultName.False, "TAPPER-M16", "Tap");
        ...
        drillTapToolBuilder1.TlDiameterBuilder.Value = 16;
