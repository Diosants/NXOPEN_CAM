...
public class M20
{
    public static void Run(string[] args)
    {
        ...
        operation1 = workPart.CAMSetup.CAMOperationCollection.CreateWithUserName(nCGroup1, method1, nCGroup2, featureGeometry1, "hole_making", "SPOT_DRILLING", NXOpen.CAM.OperationCollection.UseDefaultName.False, "CENTER-DRILL-M20", "Spot Drilling");
        ...
        nCGroup4 = workPart.CAMSetup.CAMGroupCollection.CreateToolWithUserName(nCGroup3, "hole_making", "CENTERDRILL", NXOpen.CAM.NCGroupCollection.UseDefaultName.False, "CENTER-TAP-M20", "CENTER-TAP-M20");
        ...
        NXOpen.CAM.FeatureGeometry featureGeometry2 = ((NXOpen.CAM.FeatureGeometry)workPart.CAMSetup.CAMGroupCollection.FindObject("M20"));
        if (workPart.CAMSetup.CAMGroupCollection.FindObject("M20") == null)
        {

            theUI.NXMessageBox.Show("Error", NXOpen.NXMessageBox.DialogType.Error, "Feature Geometry M20 not found.");
            return;
        }
        ...
        // OPERATION TW0 - DRILL DIAM 17.5
        NXOpen.CAM.Operation operation2;
        operation2 = workPart.CAMSetup.CAMOperationCollection.CreateWithUserName(nCGroup1, method1, nCGroup2, featureGeometry1, "hole_making", "DRILLING", NXOpen.CAM.OperationCollection.UseDefaultName.False, "DRILL-D17.5", "Drilling");
        ...
        // GETTING TOOL DIAM 17.5
        NXOpen.CAM.NCGroup nCGroup5;
        nCGroup5 = workPart.CAMSetup.CAMGroupCollection.CreateToolWithUserName(nCGroup3, "hole_making", "STD_DRILL", NXOpen.CAM.NCGroupCollection.UseDefaultName.False, "HSS-D17.5", "Std Drill");
        ...
        drillStdToolBuilder1.TlDiameterBuilder.Value = 17.5;
        drillStdToolBuilder1.TlNumberBuilder.Value = 13;

        drillStdToolBuilder1.TlAdjRegBuilder.Value = 13;
        ...
        operation3 = workPart.CAMSetup.CAMOperationCollection.CreateWithUserName(nCGroup1, method1, nCGroup2, featureGeometry1, "hole_making", "COUNTERSINKING", NXOpen.CAM.OperationCollection.UseDefaultName.False, "DEBUR-M20", "Countersinking");
        ...
        nCGroup6 = workPart.CAMSetup.CAMGroupCollection.CreateToolWithUserName(nCGroup3, "hole_making", "COUNTER_SINK", NXOpen.CAM.NCGroupCollection.UseDefaultName.True, "CHAMFERER-D16", "Counter Sink");
        ...
        drillCtskToolBuilder1.TlDiameterBuilder.Value = 22;
        ...
        operation4 = workPart.CAMSetup.CAMOperationCollection.CreateWithUserName(nCGroup1, method1, nCGroup2, featureGeometry2, "hole_making", "TAPPING", NXOpen.CAM.OperationCollection.UseDefaultName.False, "TAP-M20", "TAP-M20");
        ...
        nCGroup7 = workPart.CAMSetup.CAMGroupCollection.CreateToolWithUserName(nCGroup3, "hole_making", "TAP", NXOpen.CAM.NCGroupCollection.UseDefaultName.False, "TAPPER-M20", "Tap");
        ...
        drillTapToolBuilder1.TlDiameterBuilder.Value = 20;
