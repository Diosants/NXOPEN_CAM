...
public class M8 
{
    public static void Run(string[] args)
    {
        ...
        NXOpen.CAM.FeatureGeometry featureGeometry2 = ((NXOpen.CAM.FeatureGeometry)workPart.CAMSetup.CAMGroupCollection.FindObject("FG_STEP1POCKET_THREAD"));
        //if(workPart.CAMSetup.CAMGroupCollection.FindObject("M8") == null)
        //{     
            
        //    theUI.NXMessageBox.Show("Error", NXOpen.NXMessageBox.DialogType.Error, "Feature Geometry M8 not found.");
        //    return;
        //}
        ...
        holeDrillingBuilder2.Destroy();
          ...
          // OPERATION TW0 - DRILL DIAM 6.5
        NXOpen.CAM.Operation operation2;
        operation2 = workPart.CAMSetup.CAMOperationCollection.CreateWithUserName(nCGroup1, method1, nCGroup2, featureGeometry1, "hole_making", "DRILLING", NXOpen.CAM.OperationCollection.UseDefaultName.False, "DRILL-D6.5", "Drilling");
        ...
        // GETTING TOOL DIAM 6.5
        NXOpen.CAM.NCGroup nCGroup5;
        nCGroup5 = workPart.CAMSetup.CAMGroupCollection.CreateToolWithUserName(nCGroup3, "hole_making", "STD_DRILL", NXOpen.CAM.NCGroupCollection.UseDefaultName.True, "STD_DRILL", "Std Drill");
        ...
        drillStdToolBuilder1.TlNumberBuilder.Value = 11;

        drillStdToolBuilder1.TlAdjRegBuilder.Value = 11;
        ...
        operation3 = workPart.CAMSetup.CAMOperationCollection.CreateWithUserName(nCGroup1, method1, nCGroup2, featureGeometry1, "hole_making", "COUNTERSINKING", NXOpen.CAM.OperationCollection.UseDefaultName.True, "COUNTERSINKING", "Countersinking");
        ...
        nCGroup6 = workPart.CAMSetup.CAMGroupCollection.CreateToolWithUserName(nCGroup3, "hole_making", "COUNTER_SINK", NXOpen.CAM.NCGroupCollection.UseDefaultName.True, "COUNTER_SINK", "Counter Sink");
        ...
        operation4 = workPart.CAMSetup.CAMOperationCollection.CreateWithUserName(nCGroup1, method1, nCGroup2, featureGeometry2, "hole_making", "TAPPING", NXOpen.CAM.OperationCollection.UseDefaultName.True, "TAPPING", "Tapping");
        ...
        nCGroup7 = workPart.CAMSetup.CAMGroupCollection.CreateToolWithUserName(nCGroup3, "hole_making", "TAP", NXOpen.CAM.NCGroupCollection.UseDefaultName.True, "TAP", "Tap");
        ...
        drillTapToolBuilder1.TlDiameterBuilder.Value = 6.5;

        drillTapToolBuilder1.TlNumberBuilder.Value = 13;

        drillTapToolBuilder1.TlAdjRegBuilder.Value = 13;
