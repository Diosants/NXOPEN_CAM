...
public class M12_SOCKET_HEAD
{
    public static void Run(string[] args)
    {
        ...
        NXOpen.CAM.FeatureGeometry featureGeometry1 = ((NXOpen.CAM.FeatureGeometry)workPart.CAMSetup.CAMGroupCollection.FindObject("M12_SOCKET_HEAD"));
        ...
        nCGroup5 = workPart.CAMSetup.CAMGroupCollection.CreateToolWithUserName(nCGroup3, "hole_making", "SPOT_DRILL", NXOpen.CAM.NCGroupCollection.UseDefaultName.False, "HSS-DRILL-13.5MM", "Spot Drill");
        ...
        drillSpotdrillToolBuilder1.TlDiameterBuilder.Value = 13.5;
        drillSpotdrillToolBuilder1.TlNumberBuilder.Value = 12;
        drillSpotdrillToolBuilder1.TlAdjRegBuilder.Value = 12;
        ...
        NXOpen.CAM.Method method3 = ((NXOpen.CAM.Method)workPart.CAMSetup.CAMGroupCollection.FindObject("METHOD"));
