...
public class M24_SOCKET_HEAD
{
    public static void Run(string[] args)
    {
        ...
        NXOpen.CAM.FeatureGeometry featureGeometry1 = ((NXOpen.CAM.FeatureGeometry)workPart.CAMSetup.CAMGroupCollection.FindObject("M24_SOCKET_HEAD"));

        NXOpen.CAM.Operation operation1;
        operation1 = workPart.CAMSetup.CAMOperationCollection.CreateWithUserName(nCGroup1, method1, nCGroup2, featureGeometry1, "hole_making", "SPOT_DRILLING", NXOpen.CAM.OperationCollection.UseDefaultName.False, "CT_HSM24", "Spot Drilling");
        ...
        nCGroup4 = workPart.CAMSetup.CAMGroupCollection.CreateToolWithUserName(nCGroup2, "hole_making", "CENTERDRILL", NXOpen.CAM.NCGroupCollection.UseDefaultName.True, "CTDRILL_SCK-M24", "Centerdrill");
        ...
        operation2 = workPart.CAMSetup.CAMOperationCollection.CreateWithUserName(nCGroup1, method1, nCGroup2, featureGeometry1, "hole_making", "DRILLING", NXOpen.CAM.OperationCollection.UseDefaultName.False, "THR_HOLE_SOCK_D26", "Drilling");
        ...
        nCGroup5 = workPart.CAMSetup.CAMGroupCollection.CreateToolWithUserName(nCGroup2, "hole_making", "SPOT_DRILL", NXOpen.CAM.NCGroupCollection.UseDefaultName.False, "HSS-DRILL-26MM_SCK", "Spot Drill");
        ...
        workPart.CAMSetup.MoveObjects(NXOpen.CAM.CAMSetup.View.MachineTool, objectsToBeMoved4, nCGroup2, NXOpen.CAM.CAMSetup.Paste.Inside);
        ...
        drillSpotdrillToolBuilder1.TlDiameterBuilder.Value = 26;
        drillSpotdrillToolBuilder1.TlNumberBuilder.Value = 16;
        drillSpotdrillToolBuilder1.TlAdjRegBuilder.Value = 16;
        drillSpotdrillToolBuilder1.TlHeightBuilder.Value = 100;
        ...
        holeDrillingBuilder5.CycleTable.StepClearance = 5;
        ...
        operation3 = workPart.CAMSetup.CAMOperationCollection.CreateWithUserName(nCGroup1, method2, nCGroup2, featureGeometry1, "hole_making", "HOLE_MILLING", NXOpen.CAM.OperationCollection.UseDefaultName.False, "HOLE_MILL_D34", "Hole Milling");
        ;
        ...
        nCGroup6 = workPart.CAMSetup.CAMGroupCollection.CreateToolWithUserName(nCGroup2, "mill_planar", "MILL", NXOpen.CAM.NCGroupCollection.UseDefaultName.False, "EM-D18_SOCK_M24", "Mill");
        ...
        workPart.CAMSetup.MoveObjects(NXOpen.CAM.CAMSetup.View.MachineTool, objectsToBeMoved7, nCGroup2, NXOpen.CAM.CAMSetup.Paste.Inside);
        ...
        millToolBuilder1.TlDiameterBuilder.Value = 18.0;

        millToolBuilder1.TlNumberBuilder.Value = 19;

        millToolBuilder1.TlAdjRegBuilder.Value = 19;

        millToolBuilder1.TlCutcomRegBuilder.Value = 19;

        millToolBuilder1.TlHeightBuilder.Value = 100;
        ...
        operation4 = workPart.CAMSetup.CAMOperationCollection.CreateWithUserName(nCGroup1, method3, nCGroup2, featureGeometry1, "hole_making", "HOLE_CHAMFER_MILLING", NXOpen.CAM.OperationCollection.UseDefaultName.False, "DEBUR_D34_SOCK_M24", "Hole Chamfer Milling");
        ...
        nCGroup7 = workPart.CAMSetup.CAMGroupCollection.CreateToolWithUserName(nCGroup2, "hole_making", "CHAMFER_MILL", NXOpen.CAM.NCGroupCollection.UseDefaultName.False, "CHMFR_D12MM_SOCK_M24", "Chamfer Mill");
        ...
        workPart.CAMSetup.MoveObjects(NXOpen.CAM.CAMSetup.View.MachineTool, objectsToBeMoved10, nCGroup2, NXOpen.CAM.CAMSetup.Paste.Inside);
        ...
        millToolBuilder2.TlDiameterBuilder.Value = 12.0;
        ...
        chamferMillingBuilder2.FeedsBuilder.SpindleRpmBuilder.Value = 4000;
