...
public class M16_SOCKET_HEAD
{
    public static void Run(string[] args)
    {
        ...
        NXOpen.CAM.FeatureGeometry featureGeometry1 = ((NXOpen.CAM.FeatureGeometry)workPart.CAMSetup.CAMGroupCollection.FindObject("M16_SOCKET_HEAD"));
        ...
        operation2 = workPart.CAMSetup.CAMOperationCollection.CreateWithUserName(nCGroup1, method1, nCGroup2, featureGeometry1, "hole_making", "DRILLING", NXOpen.CAM.OperationCollection.UseDefaultName.False, "DRILL-D17.5MM", "Drilling");
        ...
        nCGroup5 = workPart.CAMSetup.CAMGroupCollection.CreateToolWithUserName(nCGroup3, "hole_making", "SPOT_DRILL", NXOpen.CAM.NCGroupCollection.UseDefaultName.False, "HSS-DRILL-17.5MM", "Spot Drill");
        ...
        drillSpotdrillToolBuilder1.TlDiameterBuilder.Value = 17.5;
        drillSpotdrillToolBuilder1.TlNumberBuilder.Value = 13;
        drillSpotdrillToolBuilder1.TlAdjRegBuilder.Value = 13;
        ...
        operation3 = workPart.CAMSetup.CAMOperationCollection.CreateWithUserName(nCGroup1, method2, nCGroup2, featureGeometry1, "hole_making", "HOLE_MILLING", NXOpen.CAM.OperationCollection.UseDefaultName.False, "HOLE_MILL-D27MM", "Hole Milling");
        ;
        ...
        nCGroup6 = workPart.CAMSetup.CAMGroupCollection.CreateToolWithUserName(nCGroup3, "mill_planar", "MILL", NXOpen.CAM.NCGroupCollection.UseDefaultName.False, "ENDMILL-D12MM", "Mill");
        ...
        millToolBuilder1.TlNumberBuilder.Value = 6;

        millToolBuilder1.TlAdjRegBuilder.Value = 6;

        millToolBuilder1.TlCutcomRegBuilder.Value = 6;
        ...
        operation4 = workPart.CAMSetup.CAMOperationCollection.CreateWithUserName(nCGroup1, method3, nCGroup2, featureGeometry1, "hole_making", "HOLE_CHAMFER_MILLING", NXOpen.CAM.OperationCollection.UseDefaultName.False, "HOLE_CHAMFER_D27", "Hole Chamfer Milling");
