...
public class M20_SOCKET_HEAD
{
    public static void Run(string[] args)
    {
        ...
        NXOpen.CAM.FeatureGeometry featureGeometry1 = ((NXOpen.CAM.FeatureGeometry)workPart.CAMSetup.CAMGroupCollection.FindObject("M20_SOCKET_HEAD"));
        ...
        operation2 = workPart.CAMSetup.CAMOperationCollection.CreateWithUserName(nCGroup1, method1, nCGroup2, featureGeometry1, "hole_making", "DRILLING", NXOpen.CAM.OperationCollection.UseDefaultName.False, "DRILL-D22MM", "Drilling");
        ...
        nCGroup5 = workPart.CAMSetup.CAMGroupCollection.CreateToolWithUserName(nCGroup3, "hole_making", "SPOT_DRILL", NXOpen.CAM.NCGroupCollection.UseDefaultName.False, "HSS-DRILL-22MM", "Spot Drill");
        ...
        drillSpotdrillToolBuilder1.TlDiameterBuilder.Value = 22;
        drillSpotdrillToolBuilder1.TlNumberBuilder.Value = 14;
        drillSpotdrillToolBuilder1.TlAdjRegBuilder.Value = 14;
        ...
        operation3 = workPart.CAMSetup.CAMOperationCollection.CreateWithUserName(nCGroup1, method2, nCGroup2, featureGeometry1, "hole_making", "HOLE_MILLING", NXOpen.CAM.OperationCollection.UseDefaultName.False, "HOLE_MILL-D33MM", "Hole Milling");
        ;
        ...
        nCGroup6 = workPart.CAMSetup.CAMGroupCollection.CreateToolWithUserName(nCGroup3, "mill_planar", "MILL", NXOpen.CAM.NCGroupCollection.UseDefaultName.False, "ENDMILL-D18MM", "Mill");
        ...
        operation4 = workPart.CAMSetup.CAMOperationCollection.CreateWithUserName(nCGroup1, method3, nCGroup2, featureGeometry1, "hole_making", "HOLE_CHAMFER_MILLING", NXOpen.CAM.OperationCollection.UseDefaultName.False, "HOLE_CHAMFER_D33", "Hole Chamfer Milling");
        ...
        nCGroup7 = workPart.CAMSetup.CAMGroupCollection.CreateToolWithUserName(nCGroup3, "hole_making", "CHAMFER_MILL", NXOpen.CAM.NCGroupCollection.UseDefaultName.False, "CHAMFER_D12MM", "Chamfer Mill");
