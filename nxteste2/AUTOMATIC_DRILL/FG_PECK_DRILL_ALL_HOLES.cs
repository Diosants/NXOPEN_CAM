...
public class FG_PECK_DRILL_ALL_HOLES
{
    ...
    private static readonly Dictionary<int, TapInfo> TapByColorId = new Dictionary<int, TapInfo>
    {
        ...
        { COLOR_EMERALD, new TapInfo { Name = "M12", DrillDiam = 10.5, NominalDiam = 12 } },
    ...
    private static void ProcessTapHole(
        ...
        FeatureGeometryGroup fg, int colorId, TapInfo tapInfo, LogBuffer lw)
    {
    ...
    private static void ProcessGeometryHole(
        ...
        FeatureGeometryGroup fg, int colorId, NXOpen.UF.UFSession ufs, LogBuffer lw)
    {
        List<HoleStep> steps;
        string erroDetalhe;
    ...
    private static void CreateDrillingOperation(
        ...
        string label, double? depth, double diameter, LogBuffer lw)
    {
        if (VERBOSE)
    ...
    private static void ProcessTaperedHole(
        Part workPart, NCGroup nCGroup1, NCGroup nCGroup2,
        FeatureGeometryGroup fg, NXOpen.UF.UFSession ufs, LogBuffer lw)
    {
        double diameter2;
        string erro;
    ...
    private static bool TryMeasureLocalDepthByRayTrace(FeatureGeometryGroup fg, NXOpen.UF.UFSession ufs, out double depth, out bool isThrough, LogBuffer lw)
    {
        depth = 0.0;
        isThrough = false;
    ...
    private static bool TryTraceRayBothDirections(
        ...
        out double[] hitFirst, out double[] hitLast, LogBuffer lw)
    {
        hitFirst = null;
        hitLast = null;
    ...
    private static List<FeatureGeometryGroup> FindDuplicateGroups(List<FeatureGeometryGroup> featureGroups, LogBuffer lw)
    {
