// NX 2406
// Journal created by STELMEC on Thu Jul 30 08:41:56 2026 Hora oficial do Brasil
//
using System;
using NXOpen;

public class MOLDROUGHSTRATEGY
{
    public static void Run(string[] args)
    {
        ...
        operation1 = workPart.CAMSetup.CAMOperationCollection.CreateWithUserName(nCGroup1, nCGroup2, tool1, featureGeometry1, "mill_contour", "CAVITY_MILL", NXOpen.CAM.OperationCollection.UseDefaultName.True, "CAVITY_MILL_1", "Cavity Mill 1");
        ...
        cavityMillingBuilder1.CutLevel.GlobalDepthPerCut.DistanceBuilder.Value = 3.0;
        ...
        cavityMillingBuilder1.CutParameters.FloorSameAsPartStock = false;

        cavityMillingBuilder1.CutParameters.PartStock.Value = 1.0;

        cavityMillingBuilder1.CutParameters.FloorStock.Value = 0.5;

        cavityMillingBuilder1.FeedsBuilder.SpindleRpmBuilder.Value = 3200.0;
        ...
        cavityMillingBuilder1.NonCuttingBuilder.EngageClosedAreaBuilder.HeightBuilder.Value = 1.0;

        cavityMillingBuilder1.NonCuttingBuilder.EngageOpenAreaBuilder.EngRetType = NXOpen.CAM.NcmPlanarEngRetBuilder.EngRetTypes.None;
        ...
        cavityMillingBuilder1.NonCuttingBuilder.ClearanceBuilder.SafeDistance = 10.0;
        ...
        cavityMillingBuilder1.CutParameters.SmallAreaAvoidance.AreaSize.Value = 250.0;
