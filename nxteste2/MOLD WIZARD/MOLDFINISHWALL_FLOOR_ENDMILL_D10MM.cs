...
public class MOLDFINISHWALL_FLOOR_ENDMILL_D10MM
{
    public static void Run(string[] args)
    {
        ...
        zLevelMillingBuilder1.CutLevel.GlobalDepthPerCut.DistanceBuilder.Value = 0.25;
        ...
        zLevelMillingBuilder1.FeedsBuilder.FeedCutBuilder.Value = 5000.0;
