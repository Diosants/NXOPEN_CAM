...
public class CAVITY_MILL_THREE_PLUS_TWO_TOP
{
  public static void Run(string[] args)
  {
    ...
    operation1 = workPart.CAMSetup.CAMOperationCollection.CreateWithUserName(nCGroup1, method1, tool1, featureGeometry1, "mill_contour", "CAVITY_MILL", NXOpen.CAM.OperationCollection.UseDefaultName.False, "CAVITY_MILL_TOP", "Cavity Mill");
    ...
    NXOpen.Vector3d vector2 = new NXOpen.Vector3d(0.0, 0.0, 1.0);
