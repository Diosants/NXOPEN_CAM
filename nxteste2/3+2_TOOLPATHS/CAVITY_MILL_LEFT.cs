...
public class CAVITY_MILL_THREE_PLUS_TWO_LEFT
{
  public static void Run(string[] args)
  {
    ...
    operation1 = workPart.CAMSetup.CAMOperationCollection.CreateWithUserName(nCGroup1, method1, tool1, featureGeometry1, "mill_contour", "CAVITY_MILL", NXOpen.CAM.OperationCollection.UseDefaultName.False, "CAVITY_MILL_LEFT", "Cavity Mill");
