...
public class ZlevelInteractive
{
    ...
    public void ZlevelProfile()
    {
        try
        {
            ...
            // Create operation
            var ncProgramGroup = (NXOpen.CAM.NCGroup)workPart.CAMSetup.CAMGroupCollection.FindObject("NC_PROGRAM");
            var method = (NXOpen.CAM.Method)workPart.CAMSetup.CAMGroupCollection.FindObject("METHOD");
            var noneGroup = (NXOpen.CAM.NCGroup)workPart.CAMSetup.CAMGroupCollection.FindObject("NONE");
            ...
            zLevelBuilder2.NonCuttingBuilder.EngageClosedAreaBuilder.EngRetType = NXOpen.CAM.NcmPlanarEngRetBuilder.EngRetTypes.SameAsEngage;
